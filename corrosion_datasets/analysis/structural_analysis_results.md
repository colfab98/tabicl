...
|---|---|---:|---:|---:|---:|---:|---:|
| `electrochemical_metrics_alloys` | `Pitting Potential` | 810 | 41 | 24 | 3 | 1 | 3 |
| `electrochemical_metrics_alloys` | `Repassivation Potential` | 189 | 38 | 19 | 3 | 1 | 1 |
| `electrochemical_metrics_alloys` | `Crevice Corrosion Potential` | 31 | 30 | 5 | 2 | 1 | 1 |
| `electrochemical_metrics_alloys` | `Pitting Temp` | 117 | 28 | 12 | 0 | 2 | 3 |
| `electrochemical_metrics_alloys` | `Crevice Corrosion Temp` | 70 | 34 | 17 | 0 | 1 | 2 |
| `electrochemical_metrics_alloys` | `HEAs_Ecorr, icorr, ipass, Rate` | 51 | 115 | 9 | 2 | 1 | 2 |
| `mpea_corrosion` | `Sheet1` | 619 | 39 | 28 | 1 | 0 | 4 |
| `am_mpea_corrosion` | `AM_MPEA_corrosion_database_V3` | 97 | 25 | 14 | 1 | 0 | 3 |
| `steel_mortar_corrosion` | `01_Carbonation` | 180 | 17 | 6 | 5 | 0 | 4 |
| `steel_mortar_corrosion` | `02_Chloride` | 95 | 16 | 5 | 5 | 0 | 4 |
